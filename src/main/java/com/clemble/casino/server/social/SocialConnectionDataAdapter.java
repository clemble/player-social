...
public class SocialConnectionDataAdapter {
    ...
    final private static Logger LOG = LoggerFactory.getLogger(SocialConnectionDataAdapter.class);
    ...
    public String register(ConnectionData connectionData) {
        ...
        Connection<?> connection = connectionFactoryLocator.getConnectionFactory(connectionData.getProviderId()).createConnection(connectionData);
        LOG.debug("register connection acquired for {}", connection.getKey());
        ...
        MDC.put(PlayerAware.PLAYER, player);
        LOG.debug("register {} created with connection {}", player, connection.getKey());
        ...
        LOG.debug("register {} created player profile {}", player, playerProfile);
